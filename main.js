...
const mainLight = new THREE.PointLight(0x8b5cf6, 3, 20);
mainLight.position.set(5, 5, 5);
scene.add(mainLight);

const secondaryLight = new THREE.PointLight(0xd946ef, 3, 20);
...
for(let i=0; i < nebulaCount; i++) {
    const geo = new THREE.SphereGeometry(Math.random() * 2 + 1, 32, 32);
